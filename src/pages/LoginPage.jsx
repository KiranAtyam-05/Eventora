...
import { Mail, Lock, Eye, EyeOff, ArrowRight, Calendar, Sparkles, X } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-hero flex">
      ...
      >
        ...
        >
          <div className="w-32 h-32 mx-auto mb-8 rounded-3xl bg-gradient-to-br from-primary-500 via-secondary-500 to-accent-500
                          flex items-center justify-center shadow-2xl shadow-primary-500/30 animate-float">
          ...
          <p className="text-xl text-gray-400 max-w-md mx-auto">
            Never miss a moment that matters. Schedule greetings, manage events, and create lasting memories.
          </p>
        </motion.div>
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 rounded border-gray-600 bg-transparent text-primary-500
